                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <c:forEach items="${list}" var="o">
                                                <c:if test = "${o.product != null}">
                                                    <c:set var = "totalPrice" scope = "session" value = "${o.product.price * o.amount}"/>
                                                    <tr>
                                                        <th scope="row">
                                                            <div class="p-2">
                                                                <img src="${o.product.image}" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                                <div class="ml-3 d-inline-block align-middle">
                                                                    <h5 class="mb-0"> <a href="detail?pid=${o.productID}" class="text-dark d-inline-block">${o.product.name}</a></h5><span class="text-muted font-weight-normal font-italic"></span>
                                                                </div>
                                                            </div>
                                                        </th>
                                                        <td class="align-middle"><strong>${o.product.price}</strong></td>
                                                        <td class="align-middle">
                                                            <a href="cartDecrease?STT=${o.STT}"><button class="btnSub">-</button></a> 
                                                            <strong>${o.amount}</strong>
                                                            <a href="cartIncrease?STT=${o.STT}"><button class="btnAdd">+</button></a>
                                                        </td>
                                                        <td class="align-middle"><a href="cartDelete?STT=${o.STT}" class="text-dark">
                                ...
                                <div class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Total</strong>
                                            <h5 class="font-weight-bold">${totalPrice + totalPrice * 0.1} $</h5>
                                        </li>
